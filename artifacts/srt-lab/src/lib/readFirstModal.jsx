...
/* ReadFirstModal — pre-write confirmation gate.
   Props:
     module       — string label (e.g. 'BCM')
     currentState — [{label,value}] read from the module before write (may be empty)
     newVin       — VIN being written (from MasterVinContext)
     onConfirm    — ({reviewed,titleRef,titleNotes,technician,preWriteConfirmed})
     onCancel     — ()
