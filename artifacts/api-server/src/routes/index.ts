...
import keyHistoryRouter from "./keyHistory";
import keyAddVerificationsRouter from "./keyAddVerifications";
...
router.use(keyHistoryRouter);
router.use(keyAddVerificationsRouter);
