...
## Stage D — UI/Navigation Restructure (6-Job Doors Model) (Jun 12, 2026)

- [ ] Create Section.jsx component for collapsible job door sections
- [ ] Update CommandShell.jsx to implement 6-job navigation (READ, MARRY, KEYS, FLASH, LIVE, REFERENCE)
- [ ] Update App.jsx to wire workspaceJobs model into navigation
- [ ] Verify all 61 tabs mapped to correct job doors
- [ ] Run full test suite (479 tests) to ensure no regressions
- [ ] Obtain RE agent results for 25 missing ECU hex values (0x180–0x19D) and update ecuBranchAlgorithms.js
